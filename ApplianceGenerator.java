	...
	public static void main(String[] args) throws IOException {
		...
		while (scan.hasNext()) {
			...
			app[count] = new ApplianceGenerator(stringToken.nextToken(","),
					Integer.parseInt(stringToken.nextToken(",")), Integer.parseInt(stringToken.nextToken(",")),
					Double.parseDouble(stringToken.nextToken(",")), Boolean.parseBoolean(stringToken.nextToken(",")),
		...
		try {
			...
			FileWriter fw = new FileWriter(inputFileName, false);
